<h1 align="left">`(SignalTg`, _CLI bot with fast speed and high power)_</h1><p align=centert">  <p align="left">[![Join the chat at https://gitter.im/janlou/AdvanSource](https://badges.gitter.im/AdvanSource.svg)](https://gitter.im/janlou/AdvanSource?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
<p align="left">Channel: [[ JOIN! ]](https://telegram.me/SignalTg_Team)
<p align="left">Support: [[ JOIN! ]](https://telegram.me/joinchat/)
***
...
```sh
cd $home
git clone https://github.com/mohsenbozorgi/bota
```
